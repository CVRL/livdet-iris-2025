...
class evaluation:
    ...
    def get_result(self, method,imgNames, true_label,predict_score,path, minThreshold = -1):
        ...
        spoof = []
        [spoof.append(predictScore[j]) for j in range(len(true_label)) if (true_label[j] != 0)]
...
if __name__ == '__main__':
    ...
    predict_score = [[0.8,0.20], [0.44, 0.56],[0.6,0.4],[0.7, 0.3], [0.9,0.1],[0.2,0.8],[0.3,0.7],[0.4,0.6],[0.01,0.99]]
